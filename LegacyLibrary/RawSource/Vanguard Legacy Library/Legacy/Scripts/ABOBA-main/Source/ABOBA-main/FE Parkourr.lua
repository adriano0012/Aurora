...
if (math.abs(vz.X-1) < 0 xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed Action = "HWallRunning" xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed bv.Name = "StaminaBodyObject" xss=removed xss=removed xss=removed xss=removed bg.Name = "StaminaBodyObject" xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed> math.pi then
aniplus = false
...
if counter2 - counter < 13 xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed> 8 then
...
if spd < 7 xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed> -180 then
GravPoint = GravPoint - 5.6
end
spd = spd - 0.36
end
...
if Action == "Standing" and Shift == true and (hitz == nil or hitz.CanCollide == false) and (righthitz == nil or righthitz.CanCollide == false) and (lefthitz == nil or lefthitz.CanCollide == false) and (ghitz == nil or ghitz.CanCollide == false) and (Torsoz.Velocity.y > 6 and Torsoz.Velocity.y < 50 xss=removed>= 10 then
...
if right < left xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed HWallRunning = "Jumping" Action = "HWRJumping" xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed> 15 and Torsoz.Velocity.y > -40 then
print("Sliding")
Slide()
end
elseif key == "a" then
...
if (FOV >= 70 and FOV < 74> 25 then
FOV = FOV + 1
elseif (FOV &lt;= 74 and FOV > 70) and Vector3.new(Torsoz.Velocity.x,0,Torsoz.Velocity.z).magnitude < 20 xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed> -180 then
...
if stamina > 0 then
stamina = stamina - 0.5
if stamina < 0 xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed> 12 and Action ~= "Sliding" then
if stamina < maxstamina xss=removed> maxstamina then
stamina = maxstamina
end
else
stamina = maxstamina
...
elseif Vector3.new(Torsoz.Velocity.x, 0, Torsoz.Velocity.z).magnitude < 2 xss=removed xss=removed xss=removed xss=removed xss=removed> maxstamina then
stamina = maxstamina
end
else
stamina = maxstamina
...
if v[1].Transparency < 0 xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed xss=removed> 140 then
